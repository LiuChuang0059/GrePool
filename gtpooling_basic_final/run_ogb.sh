...
# run OGB dataset 1
# ogbg-molhiv ogbg-moltox21 ogbg-moltoxcast

for attn_drop in 0.0; do
  for ratio in 0.5 0.9 0.7 0.3 0.1; do
    for n_encoders in 4 6 8; do
      for rate in 0.0; do
        for data in ogbg-molhiv ogbg-moltox21 ogbg-moltoxcast; do
          python main.py --configs configs/OGB/ogb.yml --dataset $data --device $cuda \
